    ...
    <div class="list-main-link-payment" v-if="!loading">
      <div v-if="ListPaymentLink.length > 0">
        <div class="d-flex justify-space-between align-center">
          ...
          <div>
            <v-btn small to="/painel/link_payment/create" color="primary"
              >Novo Link</v-btn
            >
          </div>
        </div>
        <div class="list_link px-5 mb-4">
          <div
            class="item d-flex justify-space-between align-center py-4"
            v-for="(data, index) in ListPaymentLink"
            :key="index"
          >
      ...
      >
        <div class="text-center card_payments py-5">
          ...
          <v-btn to="/painel/link_payment/create" color="secondary"
            >Criar link de pagamento</v-btn
          >
        </div>
      </div>
    </div>
