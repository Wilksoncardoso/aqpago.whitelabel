<template lang="html">
  <div>
    <saldo__conta :result__api="result__api" />
    <export__pix__comp />
    <div class="extrato__list__index">
      ...
      <v-btn-toggle
        ...
        mandatory
        class="tp__extrato"
        @change="tp__extrato__logic($event)"
        v-if="
          data_user_permission?.digital_account && data_user_permission?.vendas
        "
      >
        <v-btn
          class="button__logic__extrato"
          :loading="loading"
          value="conta__digital"
        >
          Conta digital
        </v-btn>
        <v-btn
      ...
      <div v-if="tp__extrato === 'conta__digital'">
        <Extrato__conta__digital
          :result__api="result__api"
          :loading="loading"
          :page_info="page_info"
        />
        <Filter__conta__digital :loading="loading" />
        <Exportar__conta__digital />

        <!-- <export__pix :page_info="page_info"  :result__api="result__api"/> -->
      </div>
      <div v-if="tp__extrato === 'vendas'">
        <Extrato__vendas
...
<script>
import saldo__conta from "~/components/page/inicio/index.vue";
import Extrato__conta__digital from "~/components/page/extratos1/index.vue";
import Filter__conta__digital from "~/components/page/extratos1/controler__filter__extrato.vue";
import Exportar__conta__digital from "~/components/page/extratos1/exportar__extrato.vue";
...
import Extrato__vendas from "~/components/page/extratos1/index__vendas.vue";
...
export default {
  ...
  data() {
    return {
      ...
      mensagem: "",
      tp__extrato: "conta__digital", // conta__digital  | vendas
      result__api: [],
      page_info: {},
      result__api__vendas: [],
      page_info__vendas: {},
  ...
  methods: {
    ...
    async extratoConsulta__vendas() {
      ...
      try {
        ...
        this.result__api__vendas = response.data;
