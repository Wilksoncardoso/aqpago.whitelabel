...
//icon vendas
import icon__cartao from "./icon__vendas/icon__cartao__extrato.vue";
import icon__pix from "./icon__vendas/icon__pix.vue";
import icon__boleto from "./icon__vendas/icon__boleto1.vue";
import icon__machine from "./icon__vendas/icon__maquinas.vue";
import icon__venda__online from "./icon__vendas/icon__VendaOnline.vue";
